...
function f8() {
    ...
    key in a8 ? out.innerHTML = a8[key] : out.innerHTML = 0;
}
...
function f19() {
    ...
    let out = '';
    for (let key in a19){
        for (let value of a19[key]){
            if (station == value.toLowerCase()){
                out += key;
            } 
        }
    }    
